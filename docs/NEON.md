...
4. Apply `drizzle-neon/0000_neon_workspace.sql` through the direct connection.
5. Ingest project, approved-source, and generated-asset documents.
6. Apply `drizzle-neon/build-lakebase-search.sql` through the direct connection.
